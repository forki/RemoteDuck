...
let website = "/RemoteDuck"

let githubLink = "http://github.com/forki/RemoteDuck"

// Specify more information about your project
let info =
  [ "project-name", "RemoteDuck"
    "project-author", "Steffen Forkmann"
    "project-summary", "RemoteDuck is a tool which allows you to show that a remote session is blocked."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/RemoteDuck" ]
